...
/**
 * @description: 时间表达式工具类(cron生成工具类)
 * @author: Kk
...
public class CronUtils {
    ...
    public static Date getStartDate(Date startDate) throws ParseException {
        String yyyyMMddS = DateUtil.format(startDate, "yyyyMMdd");
        ...
        return DateUtil.parse(yyyyMMddS + startTime + "00", "yyyyMMddHHmmss");
    }
    ...
    public static Date getEndDate(Date endDate) throws ParseException {
        String yyyyMMddE = DateUtil.format(endDate, "yyyyMMdd");
        Calendar startCal = Calendar.getInstance();
        ...
        return DateUtil.parse(yyyyMMddE + endTime + "00", "yyyyMMddHHmmss");
    }
